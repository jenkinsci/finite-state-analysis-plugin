 ...
 *
 * <p>Every analysis runs through the public v0 REST API flow ({@link #executeViaApi}): resolve the
 ...
 *
 * <p>Binary uploads use the mb-api upload façade ({@code POST /scans/upload}), a single contract
...
public class FiniteStateExecutionFramework {
    ...
    /**
     * Execute a Finite State analysis via the public v0 REST API with common error handling and
     * logging.
     *
     ...
     * @param workspace Workspace directory where the scan file is accessed
     * @param launcher Jenkins launcher (part of the publisher contract; unused by the REST transport)
